        ...
        <div className="relative w-full h-full rounded-xl bg-gradient-to-br from-primary to-accent p-[2px]">
          <div className="w-full h-full rounded-[10px] bg-background flex items-center justify-center">
            ...
            >
              ...
              <path d="M12 2a4 4 0 0 1 4 4v1a3 3 0 0 1 3 3v1a3 3 0 0 1-1.5 2.6 3 3 0 0 1 .5 1.4v1a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4v-1a3 3 0 0 1 .5-1.4A3 3 0 0 1 5 11v-1a3 3 0 0 1 3-3V6a4 4 0 0 1 4-4z" stroke={`url(#logoGradient-${size})`} />
              <circle cx="9" cy="10" r="1" fill="hsl(var(--primary))" />
              <circle cx="15" cy="10" r="1" fill="hsl(var(--accent))" />
              <path d="M9 14h6" stroke={`url(#logoGradient-${size})`} />
              <path d="M12 6v4" stroke={`url(#logoGradient-${size})`} />
            </svg>
          </div>
        </div>
      </div>
